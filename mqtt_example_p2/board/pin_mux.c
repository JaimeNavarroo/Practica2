...
void BOARD_InitPins(void) {
  ...
  PORT_SetPinMux(PORTE, PIN26_IDX, kPORT_MuxAsGpio);         /* PORTB26 (pin 68) is configured as PTB22 */
  PORT_SetPinMux(PORTB, PIN21_IDX, kPORT_MuxAsGpio);         /* PORTB21 (pin 68) is configured as PTB22 */
